  ...
  const fetchDashboardData = async (isRefresh = false) => {
    try {
      ...
      const [statsResponse, callsResponse] = await Promise.all([
        ...
        axios.get(`${API_BASE}/api/calls?limit=4`)
      ]);
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
          ...
          <button
            ...
            disabled={refreshing}
            className="text-sm text-primary-600 hover:text-primary-700 font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
          >
            {refreshing ? (
              <>
                ...
                <tr>
                  <td colSpan="5" className="px-6 py-8 text-center text-gray-500">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-sm">Calls will appear here once they are made</p>
                    </div>
                  </td>
                </tr>
              )}
